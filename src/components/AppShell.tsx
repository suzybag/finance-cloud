    ...
    <div className="min-h-screen text-slate-100">
      <div className="flex min-h-screen">
        ...
        <main className={`ultra-shell-bg flex-1 p-4 pb-28 sm:p-6 sm:pb-28 lg:p-10 lg:pb-10 ${contentClassName ?? ""}`}>
          <nav className="navbar relative mb-5 border-base-content/25 bg-base-100 max-sm:rounded-box max-sm:shadow-sm sm:z-1 sm:border-b">
            <button
              type="button"
            ...
            <div className="flex flex-1 items-center">
              <span className="link link-neutral text-xl font-semibold no-underline">
                Finance Cloud
              </span>
            </div>
              ...
              <div className="dropdown relative inline-flex [--auto-close:inside] [--offset:8] [--placement:bottom-end]">
                ...
                >
                  <div className="dropdown-header justify-center">
                    <h6 className="text-base text-base-content">Notificacoes</h6>
                  </div>
                  ...
                  <span className="dropdown-footer justify-center gap-1">
              ...
              <div className="dropdown relative inline-flex [--auto-close:inside] [--offset:8] [--placement:bottom-end]">
                  ...
                  <div className="avatar">
                    <div className="size-9.5 rounded-full">
                      {avatarUrl ? (
                        ...
                        <div className="grid h-full w-full place-items-center rounded-full bg-neutral text-neutral-content text-xs font-semibold">
                          {initials}
                        </div>
                      )}
                    </div>
                ...
                >
                  <li className="dropdown-header gap-2">
                    <div className="avatar">
                      <div className="w-10 rounded-full">
                        {avatarUrl ? (
                          ...
                          <div className="grid h-10 w-10 place-items-center rounded-full bg-neutral text-neutral-content text-xs font-semibold">
                            {initials}
                          </div>
                        )}
                      </div>
                    ...
                    <div>
                      <h6 className="text-base text-base-content font-semibold">{displayName}</h6>
