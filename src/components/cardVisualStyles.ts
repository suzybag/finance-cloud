...
export const CARD_VISUAL_IMAGE_CLASS =
  "pointer-events-none absolute inset-0 block h-full w-full max-h-full max-w-full select-none object-contain object-center [transform:translateZ(44px)] drop-shadow-[0_14px_28px_rgba(0,0,0,0.58)]";
